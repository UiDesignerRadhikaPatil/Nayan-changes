...
const UpdateSellerDetails = () => {
    ...
    const fetchSeller = (Id) => {
        ...
        axios.get('https://truecodeapi.microtechsolutions.co.in/api/Employee', {
            params: {
                Id
            }
        }).then((response) => {
            const result = response.data;
            setSellAddress(result.address);
    ...
    const updateDetails = () => {
        ...
        //     toast.warning("Enter District");
            ...
            axios.post('https://truecodeapi.microtechsolutions.co.in/api/Employee', {
